...
module.exports = {
	// CSS
	css: options => src(options.src, { cwd: process.cwd() })
		.pipe(plumber())
	...
	// JavaScript
	js: options => src(options.src, { cwd: process.cwd() })
		.pipe(plumber())
		.pipe(dev(sourceMaps.init))
	...
	// Images
	images: options => src(options.src, { cwd: process.cwd() })
	...
	// Raw copy
	copy: options => src(options.src, { cwd: process.cwd() })
	...
	// HTML
	html: options => src(options.src, { cwd: process.cwd() })
		.pipe(data(file => ({
